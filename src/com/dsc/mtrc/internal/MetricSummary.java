...
public class MetricSummary {
	...
	public Response MetricSummary(JSONObject inputJsonObj) throws JSONException {
...
//        String mtrcid=inputJsonObj.get("mtrcid").toString();
        ...
        String mm="";
        String fullyear="N";
        String dsplymetricid="";
        String dsplymetricname="";
        String dsplymetrictext="";
        String dsplympgtext="";
        String dsplymdesctext="";
	          ...
	          ResultSetMetaData rsmd = rs.getMetaData();
                   ...
                   int  numColumns = rsmd.getColumnCount(); 
					...
					while (rs.next()) {
				        ...
				        dsplymetricid=rs.getString(1);
						dsplymetricname=rs.getString(2);
				        dsplymetrictext=rs.getString(3);
				        dsplympgtext=rs.getString(5);
				        dsplymdesctext=rs.getString(6);
									             ...
									             rcount=0;
										          ...
										          numColumns = rsmd.getColumnCount(); 
													while (rs.next()) 
													{
													 ...
													 obj1.put("mtrc_id",dsplymetricid);
													 obj1.put("mtrc_name",dsplymetricname);
													 obj1.put("mtrc_prod_display_text",dsplymetrictext);
													 obj1.put("mpg_display_text",dsplympgtext);
													 obj1.put("mtrc_period_desc",dsplymdesctext);
